...
namespace Behat\ZF2Extension\ServiceContainer;

use Behat\Behat\Context\ServiceContainer\ContextExtension;
use Behat\Behat\Gherkin\ServiceContainer\GherkinExtension;
use Behat\ZF2Extension\ServiceContainer\Driver\SymfonyFactory;
...
class ZF2Extension implements ExtensionInterface
{
    ...
    {
        $definition = new Definition('Behat\ZF2Extension\Context\ContextClass\KernelAwareClassGenerator');
    ...
    {
        $definition = new Definition('Behat\ZF2Extension\Context\Initializer\KernelAwareInitializer', array(
    ...
    {
        $definition = new Definition('Behat\ZF2Extension\Specification\BundleFeatureLocator', array(
    ...
    {
        $definition = new Definition('Behat\ZF2Extension\Suite\SymfonySuiteGenerator', array(
            new Reference(self::KERNEL_ID),
            $config['path_suffix'],
            $config['class_suffix'],
        ));
    ...
    {
        $definition = new Definition('Behat\ZF2Extension\Context\Argument\ServiceArgumentResolver', array(
            new Reference(self::KERNEL_ID)
        ));
